...
def generator_train2(datadb,segment_index_tar=None,segment_index_tar_future=None,phase='train'):
    ...
    if  phase in ['val','test']:
        ...
        datadb_keys_longerthan20 = ['146','153','154','158','190','079','128','058','136','032','019','031','118','170','160','028','209',
    ...
    while True:
        ...
        for _target_user in range(datadb[_video_ind]['x'].shape[0]):
            ...
            if _target_user==0 and cfg.use_saliency:
                ...
                saliency_data = util.load_h5('/scratch/cl2840/360video/temp/saliency_input_pad0_fulllen/input'+_video_ind+'.hdf5','input')
...
#     saliency_data = util.load_h5('/scratch/cl2840/360video/temp/saliency_input_pad0_fulllen/input'+key+'.hdf5','input')
